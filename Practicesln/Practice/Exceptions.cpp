...
//        //throw;
//    }
//    // derived class exception should be caught first beacuase derived obj can be upcated into base obj if we 
//    // catch base obj first and it's give undefined behaviour.
...
//    }
//    catch (...) {
//        std::cout << "Exception occured caught all exceptions here\n";
//    }
//
//
